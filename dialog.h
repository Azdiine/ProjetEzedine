...
private slots:
    ...
    void on_idclient_payment_line_textChanged(const QString &arg1);

    void on_idclient_payment_line_editingFinished();

    void on_id_payment_line_textChanged(const QString &arg1);

    void on_id_payment_line_editingFinished();

    void on_idreservation_payment_line_textChanged(const QString &arg1);

    void on_idreservation_payment_line_editingFinished();

    void on_id_employee_payment_line_textChanged(const QString &arg1);

    void on_id_employee_payment_line_editingFinished();

    void on_employeerole_payment_line_textChanged(const QString &arg1);

    void on_employeerole_payment_line_editingFinished();

    void on_cardname_payment_line_textChanged(const QString &arg1);

    void on_cardname_payment_line_editingFinished();

    void on_cardnum_payment_line_textChanged(const QString &arg1);

    void on_cardnum_payment_line_editingFinished();
